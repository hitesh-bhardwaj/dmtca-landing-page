      ...
      <section id="hero" className="">
        <div className="w-screen h-[130vw] relative overflow-hidden container-lg pt-[3%] mobile:h-[240vw] mobile:pt-[7%]">
          ...
          <div className="relative z-10">
            <h1 className="text-white text-[10vw] leading-[1] text-head font-light uppercase flex flex-col gap-[1vw] opacity-90 mobile:text-[14vw] mobile:gap-[4vw]">
              <span data-para-anim>Live In</span>
              <div className="flex items-start gap-[1.5vw] mobile:flex-col mobile:items-start mobile:gap-[4vw]">
                <span data-para-anim>Grandeur</span>
                <a data-scroll data-scroll-to data-scroll-duration="2s" href="#about" className="w-fit mt-[0.5vw] mobile:mt-0 h-fit p-[2vw] rounded-full flex justify-center items-center border-[2px] border-white cursor-pointer fadeup mobile:p-[4vw]">
