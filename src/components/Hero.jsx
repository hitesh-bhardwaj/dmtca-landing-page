      ...
      <section id="hero" className="">
        <div className="w-screen h-[130vw] relative overflow-hidden container-lg pt-[3%]">
          ...
          <div className="w-[55%] flex flex-col gap-[6vw] mt-[15vw] mb-[8vw]">
            <p data-para-anim className="text-[1.5vw] text-white tracking-wide opacity-90 w-[80%]">Experience Iconic Luxury Living at Dubai’s Most Prestigious and Exclusive Address</p>
          ...
          <div className="relative z-10">
            <h1 className="text-white text-[10vw] leading-none text-head font-light uppercase flex flex-col gap-[1vw] opacity-90">
              <span data-para-anim>Live</span>
              <span data-para-anim>In</span>
              <div className="flex items-center gap-[1.5vw]">

                <span data-para-anim>Grandeur</span>
                <span className="w-fit h-fit p-[2vw] rounded-full flex justify-center items-center border-[2px] border-white cursor-pointer fadeup">
          ...
          <div className="flex flex-col my-[10vw] gap-[6vw]">
            ...
            <p data-para-anim className="text-[1.5vw] text-white opacity-90 tracking-wide w-[40%]">We Elevate Your Lifestyle With World-Class Architectural Creations</p>
          </div>
          <div className="">
