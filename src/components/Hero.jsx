            ...
            <div className="flex justify-between items-center">
              <Link href="/" className="block fadeup">
                <Image
                  ...
                  width={160}
                  height={24}
                  className="object-contain mobile:w-[30vw] tablet:w-[20vw] max-h-[24px]"
                />
              </Link>
              <div className="flex items-center gap-8">
                <div className="logo flex gap-8 text-white items-center">
                  <a href="tel: `${finalData?.phone}`">
                    <Phone className="h-5 w-5"/>
                  </a>
                  <a href="mailto: `${finalData?.email}`">
