        ...
        <section className="relative w-screen h-screen">
            ...
            <div className="slides w-screen h-screen absolute overflow-hidden place-items-center">
                ...
                >
                    ...
                    <div className="absolute w-fit z-[2] pointer-events-auto flex gap-4 left-[5%] top-[28%] cursor-pointer">
                        <div className="group h-[7vw] w-[7vw] relative">
                            ...
                            <div className="absolute left-[110%] top-[-50%] pointer-events-none">
                                <p className="text-[1.25vw] absolute group-hover:translate-y-[5vw] top-[10%] group-hover:opacity-0 duration-300 text-white w-[5vw] leading-[1.2]">Flat Roof Terraces</p>
                    ...
                    <div className="absolute w-fit z-[2] pointer-events-auto flex gap-4 right-[30%] top-[45%] cursor-pointer">
                        <div className="group h-[7vw] w-[7vw] relative">
                            <div className="rounded-full group-hover:bg-white/40 group-hover:border-white/0 duration-300 h-[7vw] w-[7vw] border-2 border-white flex items-center justify-center">
                                <span className="bg-white/20 h-[40%] w-[40%] z-[0] rounded-full flex items-center justify-center relative">
                                    <span className="bg-white block h-[50%] w-[50%] shadow z-[1] static rounded-full" />
                            ...
                            <div className="absolute left-[110%] top-[-50%] pointer-events-none">
                                <p className="text-[1.25vw] absolute group-hover:translate-y-[5vw] top-[10%] group-hover:opacity-0 duration-300 text-white w-[5vw] leading-[1.2]">Minimalist Exterior Design</p>
                    ...
                    <div className="absolute w-fit z-[2] pointer-events-auto flex gap-4 left-[60%] top-[75%] cursor-pointer">
                        <div className="group h-[7vw] w-[7vw] relative">
                            <div className="rounded-full group-hover:bg-white/40 group-hover:border-white/0 duration-300 h-[7vw] w-[7vw] border-2 border-white flex items-center justify-center">
                                <span className="bg-white/20 h-[40%] w-[40%] z-[0] rounded-full flex items-center justify-center relative">
                                    <span className="bg-white block h-[50%] w-[50%] shadow z-[1] static rounded-full" />
