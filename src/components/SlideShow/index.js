...
const SlideShow = () => {
  // Refs for slides and their inner images
  const slidesRef = useRef([]);
  const slidesInnerRef = useRef([]);

  // State for current slide and animation flag
  const [current, setCurrent] = useState(0);
  const [isAnimating, setIsAnimating] = useState(false);

  const slidesTotal = 3; // Total number of slides

  useEffect(() => {
    // Add 'slide--current' class to the initial slide
  ...
  const navigate = (direction) => {
    ...
    // Add 'slide--current' class to upcoming slide
        ...
        <section className="relative w-screen h-screen">
            <div className="w-full h-full absolute z-10 top-0 left-0 bottom-0 right-0 grid place-items-end px-16 py-10 pointer-events-none">
                <nav className="flex gap-4 pointer-events-auto">
                    <button
                        className="w-[3vw] group border border-white rounded-full h-[3vw] flex items-center relative justify-center p-[1vw] overflow-hidden"
                    ...
                    <button
                        className="w-[3vw] border group border-white rounded-full h-[3vw] flex items-center relative justify-center p-[1vw] overflow-hidden"
            ...
            <div className="slides w-screen h-screen absolute overflow-hidden place-items-center">
                    <div
                        className="slide"
                        ref={(el) => (slidesRef.current[0] = el)}
                    >

                        <div className="absolute w-fit z-[2] pointer-events-auto flex gap-4 left-[5%] top-[28%]">
                            <div className="group h-[7vw] w-[7vw] relative">
                                ...
                                <div className="absolute left-[110%] top-[-50%] pointer-events-none">
                                    <p className="text-[1.25vw] absolute group-hover:translate-y-[5vw] group-hover:opacity-0 duration-300 text-white w-[5vw] font-body">Flat Roof Terraces</p>
                        ...
                        <div className="absolute w-fit z-[2] pointer-events-auto flex gap-4 right-[30%] top-[45%]">
                            <div className="group h-[7vw] w-[7vw] relative">
                                <div className="rounded-full group-hover:bg-white/40 group-hover:border-white/0 duration-300 h-[7vw] w-[7vw] border-2 border-white flex items-center justify-center">
                                    <span className="bg-white/20 h-[40%] w-[40%] z-[0] rounded-full flex items-center justify-center">
                                        <span className="bg-white block h-[50%] w-[50%] shadow z-[1] rounded-full" />
                                ...
                                <div className="absolute left-[110%] top-[-50%] pointer-events-none">
                                    <p className="text-[1.25vw] absolute group-hover:translate-y-[5vw] group-hover:opacity-0 duration-300 text-white w-[5vw] font-body">Minimalist Exterior Design</p>
                                    <div className="bg-white/20 group-hover:translate-y-[-5vw] group-hover:opacity-100 opacity-0 duration-300 backdrop-blur-sm rounded-xl w-[20vw] p-[1vw]">
                                        <p className="text-white text-[1.25vw] leading-[1.2]">
                        ...
                        <div className="absolute w-fit z-[2] pointer-events-auto flex gap-4 left-[60%] top-[75%]">
                            <div className="group h-[7vw] w-[7vw] relative">
                                <div className="rounded-full group-hover:bg-white/40 group-hover:border-white/0 duration-300 h-[7vw] w-[7vw] border-2 border-white flex items-center justify-center">
                                    <span className="bg-white/20 h-[40%] w-[40%] z-[0] rounded-full flex items-center justify-center">
                                        <span className="bg-white block h-[50%] w-[50%] shadow z-[1] rounded-full" />
                                ...
                                <div className="absolute left-[110%] top-[-50%] pointer-events-none">
                                    <p className="text-[1.25vw] absolute group-hover:translate-y-[5vw] group-hover:opacity-0 duration-300 text-white w-[5vw] font-body">Stone Facade</p>
                                    <div className="bg-white/20 group-hover:translate-y-[-5vw] group-hover:opacity-100 opacity-0 duration-300 backdrop-blur-sm rounded-xl w-[18vw] p-[1vw]">
                                        <p className="text-white text-[1.25vw] leading-[1.2]">
                                            Lumière Havens volumes are united by a minimalist exterior design, while the interiors are very rich in texture. The palette of materials includes pale plaster.
                                        </p>
                        ...
                        <div className="text-white text-center absolute top-10 z-[2] w-[35%] mx-auto">
                            <p className="text-[1.25vw]">Own Your Global Property!</p>
                            <span className="block h-[1px] w-full bg-gradient-to-r my-2 from-transparent from-0% via-white via-50% to-transparent to-100%" />
                            <h3 className="text-[3.3vw] font-head leading-[1.2]">Live Where Prestige and Luxury Meet with DMTCA</h3>
                        </div>
                        <div className="bg-white/20 backdrop-blur-sm absolute w-fit rounded-xl text-white p-[1.5vw] z-[2] bottom-10 left-16">
