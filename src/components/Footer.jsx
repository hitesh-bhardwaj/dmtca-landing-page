      ...
      <div className="container-lg w-screen h-full rounded-t-[40px] overflow-hidden bg-[#E0D4C6] text-[#1C1B1A] mobile:py-[10%] tablet:pt-[5%]">
        <div className=" pt-[5%] pb-[2%] flex flex-col">
          ...
          <div className="flex items-center flex-col justify-center">
            <Link
              href={`tel: ${finalData?.phone}`}
              className="text-[3.4vw] font-medium text-head leading-none mobile:text-[5.5vw] tablet:text-[5vw]"
            >
              <span data-para-anim className="">
                {finalData?.phone}
              </span>
            </Link>
            <Link href={`mailto: ${finalData?.email}`}>
              <p
                data-para-anim
                className="text-[3.4vw] text-head font-medium mobile:text-[5.5vw] tablet:text-[5vw]"
              >
                {finalData?.email}
              </p>
            </Link>
          ...
          <div className="flex items-center justify-between tablet:flex-col mobile:gap-[5vw] fadeup pt-[7vw] tablet:gap-[3vw]">
            <div className="w-[15%] tablet:w-[70%] tablet:order-1">
              <p className="text-[1.1vw] uppercase mobile:text-[3.5vw] tablet:text-center tablet:text-[2.5vw]">
                All rights reserved
              </p>
            </div>
            <div className="w-[30%] tablet:w-[80%] ml-[-5%] tablet:ml-0">
              <p className="text-[1.1vw] leading-[1.2] text-center mobile:text-[3.5vw] tablet:text-center tablet:text-[2.5vw]">
                {finalData?.address}
              </p>
            </div>
            <Link href={"#"} className="tablet:order-3">
              <div>
                <p className="text-[1.1vw]  uppercase mobile:text-[3.2vw] mobile:text-center tablet:text-[2.5vw]">
                  PRIVACY POLICY
                </p>
              </div>
            </Link>
