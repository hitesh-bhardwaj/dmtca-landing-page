    ...
    >
      <div className="container-lg h-full relative">
        <div className="flex w-full gap-[10vw] tablet:flex-col">
          ...
          Invest in Luxury That Stands the Test of Time
          </h2>
        ...
        <div className="w-full h-full mt-[48vw] flex justify-end tablet:mt-[7vw]">
          ...
          53 West 53 offers a unique blend of luxury and strategic advantage. With cutting-edge facilities and a 
dynamic environment, this property enhances your portfolio and expands your global reach. Here, you 
engage with elite peers and discover unparalleled opportunities, all while solidifying your legacy in one of 
