        ...
        <div className="flex flex-col items-center justify-center w-full h-full gap-[5vw]">
          <div className="flex flex-col items-center justify-center">
            ...
            <div className="w-full h-full flex justify-center gap-[3vw] text2">
              ...
              <div className="h-full w-[20vw] relative rounded-[20px] tablet:absolute mobile:top-[27%] tablet:w-[90vw] tablet:top-[35%]">
          ...
          <div className="w-[70%] mt-[0vw] mobile:mt-[85vw] tablet:w-full tablet:mt-[55vw]">
            <p className="text-body text-center tablet:text-start text-4">
              At DMTCA, we artfully combine design brilliance, innovative
              technology, and human insight to deliver unparalleled real estate
              experiences. Our approach goes beyond conventional sales, turning
              properties into coveted lifestyle statements. We understand that
              discerning investors seek more than just luxury; they desire a
              unique experience that complements their elevated lifestyle.
              Through our expertise, we connect clients with extraordinary
              properties that reflect their sophisticated tastes and desires
            </p>
          </div>
        </div>
      </div>
