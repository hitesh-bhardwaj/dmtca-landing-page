            ...
            <div className={`relative w-full h-full `} data-scroll
                ...
                <div className="slides w-screen h-screen absolute overflow-hidden place-items-center tablet:h-[80vh]">
                    ...
                    >
                        ...
                        <div className="text-white text-center left-1/2 -translate-x-1/2 absolute top-10 z-[2] w-[45%] mx-auto tablet:w-[90%]">
                            ...
                            <h3 className="text-[3.3vw] font-head leading-[1.2] tablet:text-[6vw]">Command Influence and Prestige at Dubai's Iconic 53 West 53
                            </h3>
                        </div>
