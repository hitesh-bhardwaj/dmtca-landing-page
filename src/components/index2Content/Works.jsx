      ...
      <section id="works" className="w-full h-full overflow-hidden mobile:bg-[#1C1B1A] tablet:bg-[#1C1B1A] tablet:py-[10%]">
        <div className="container-lg h-full  py-[5%] relative ">
          <div className="w-full flex justify-center relative z-[2]">
            ...
            >
              Position Yourself at the Epicenter of Global Opportunities
          ...
          <div className="w-full h-full flex-col mt-[10vw] relative z-[2] mobile:mt-[20vw]">
            <div className="flex w-full h-full justify-between mobile:flex-col mobile:gap-[10vw]">
              ...
              >
                ...
                At 53 West53, you can enjoy luxury living while maximizing returns, allowing you to focus on expanding 
your business ventures without the burden of excessive taxation. The property’s investment-friendly 
environment features zero income tax, enhancing your financial growth potential. 
            ...
            >
              ...
              <div className="w-[47vw] h-full flex ml-[3%] mt-[5vw] tablet:w-[80vw] mobile:w-full mobile:ml-0">
                ...
                53 West 53 is reserved for those who shape the world. This exclusive address combines elite craftsmanship 
with stunning design, offering an unparalleled blend of comfort and class. Owning a residence here is a 
testament to your vision, success, and a future defined by power.
            ...
            >
              ...
              >
                ...
                <p data-para-anim className="text-white">
                Surrounded by beautifully landscaped gardens and breathtaking views of the Dubai skyline, 53 West 53 
creates an atmosphere of tranquility and sophistication. Each space is meticulously designed to harness 
natural light, fostering an inspiring environment that encourages creativity and refined living.
