                    ...
                    <div className="w-[90%] flex flex-col">
                        ...
                        <div className="text-center group" id="p1">
                            <div className="flex w-fit mx-auto items-center justify-center mb-[2.8vw] relative gap-[1.5vw]">
                                <p className="uppercase text-head text-white group-hover:translate-x-[-4.5vw] duration-300 text-[4.5vw] leading-[1] ease-out">
                                    25+ Years in Business
                                </p>
                                <div className="w-[8vw] absolute right-[-9%] h-[8vw] -top-1/2 rounded-full overflow-hidden ml-[1.5vw] scale-0 duration-300 ease-out group-hover:scale-100">
                        ...
                        <div className="text-center group" id="p2">
                            ...
                            <p className="uppercase text-head text-white group-hover:translate-x-[-4.5vw] duration-300 text-[4.5vw] leading-[1] ease-out">
                                ...
                                <div className="w-[8vw] absolute right-[35%] h-[8vw] -top-1/2 overflow-hidden ml-[1.5vw] scale-0 duration-300 ease-out group-hover:scale-100 circle-clip">
                        ...
                        <div className="text-center group" id="p3">
                            <div className="flex items-center justify-center mt-[3.5vw] mb-[2.8vw] relative gap-[1.5vw]">
                            <p className="uppercase text-head text-white group-hover:translate-x-[-7vw] duration-300 text-[4.5vw] leading-[1] ease-out">
                                    20+
                                </p>{" "}
                                <div className="w-[14vw] absolute right-[62%] h-[8vw] -top-1/2 overflow-hidden ml-[1.5vw] scale-0 duration-300 ease-out group-hover:scale-100 rounded-xl">
