    ...
    <div className="relative w-full flex gap-[1vw]">
      ...
      {placeholderIcon && (
       <span className="absolute top-[50%] -translate-y-[50%] left-[4.5%]">
        <Image src={placeholderIcon} alt="form-icons" width={20} height={20} className="object-contain h-5 w-5"
               />
       </span>
      )}
      <input
