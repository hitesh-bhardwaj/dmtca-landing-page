...
const Gallery = () => {
  ...
  const renderHeadings = () => {
    ...
    return (
      <div className="w-full mt-[10vw] grid grid-cols-2 gap-x-[42%] justify-between tablet:flex tablet:flex-col tablet:order-1 tablet:gap-[5vw] tablet:mt-[12vw]">
        {features.map((feature, index) => (
          ...
          >
            <div className="fadeup flex gap-[2vw] items-center mb-[0.5vw] px-[1vw] tablet:gap-[4vw] tablet:mb-[1.5vw]">
              <div className="h-[2.5vw] w-[2.5vw] tablet:w-[10vw] tablet:h-[10vw]">
              ...
              <h4 className="font-head uppercase text-[1.25vw] tablet:text-[4.5vw]">
                {feature.name}
              </h4>
            </div>
  ...
  return (
    <section className="py-[8%] bg-[#E0D4C6] relative z-10" ref={bodyRef} >
      <div className="container-lg">
        ...
        <div className="w-full mt-[12vw] mb-[8vw] relative tablet:flex tablet:flex-col">
          {renderHeadings()}
          <div className="w-[35%] h-[45vw] z-10 overflow-hidden absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 fadeup tablet:static tablet:translate-x-0 tablet:translate-y-0 tablet:w-[90vw] tablet:h-[120vw]">
